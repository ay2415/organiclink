...
class GradingInferenceEngine:
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            # Must match train_v7.py's eval_transform exactly: direct resize to
            # 224x224 (no CenterCrop). The previous Resize(256)+CenterCrop(224)
            # discarded whatever fell outside the center square - a silent
            # train/inference mismatch for any non-square photo (i.e. almost
            # every real farmer photo).
